 ...
 * @className data_structures.monotonous_stack.SumOfSubarrayMinimums
 */
package data_structures.monotonous_stack;

/**
 * SumOfSubarrayMinimums
 * @description 所有子数组最小值之和
...
public class SumOfSubarrayMinimums {
    ...
    /**
     * ================================================================================================================
     * @title subArrayMinSum1
     * @author SongJian
     * @param: arr
     * @updateTime 2023/1/3 13:09
     * @return: int
     * @throws
     * @description 暴力解
     */
    ...
    /**
     * ================================================================================================================
     * @title subArrayMinSum2
     * @author SongJian
     * @param: arr
     * @updateTime 2023/1/3 13:14
     * @return: int
     * @throws
     * @description 没有使用单调栈
     */
     ...
     * @author SongJian
     * @param: arr
     * @updateTime 2023/1/3 13:26
     * @return: int
     * @throws
     * @description 单调栈优化 O(N)
     */
