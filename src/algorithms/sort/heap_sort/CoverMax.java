 ...
 * @className algorithms.sort.heap_sort.CoverMax
 */
package algorithms.sort.heap_sort;
...
public class CoverMax {
     ...
     * @author SongJian
     * @param: lines
     * @updateTime 2022/11/26 12:18
     * @return: int
     * @throws
     * @description  使用堆方法 O(NlogN)
     */
    ...
    public static int maxCover2(int[][] m) {
        ...
        // 最小堆：每一条线段的结尾数值，把小于等于 cur.start 的元素弹出
